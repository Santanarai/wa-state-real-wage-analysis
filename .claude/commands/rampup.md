...
- Any open issues or blockers from SESSION_STATE.md
- Any methodology decisions from the Notion page that affect the current session

Do not start writing code until this ramp-up is complete and confirmed.
